...
let bot = client.users.get('614309964097388545');
let nb = client.users.get('334235222193209348');  
   message.delete().catch();
  ...
  if(message.mentions.users.first().id === "614309964097388545") return message.channel.send(fEmbed1);
  if(message.mentions.users.first().id === "334235222193209348") return message.channel.send(fEmbed2);
