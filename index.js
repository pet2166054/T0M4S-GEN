...
client.on("ready",  async () => {
  ...
  client.user.setGame(`gen help in ${client.guilds.size} Servers`, `https://discordapp.com/invite/PVUgwVf`);
});
...
client.login("NjE0MzA5OTY0MDk3Mzg4NTQ1.XV9nNQ.X9nvH_yUoD9y7a9Mhz03wZ2TQEY");
